...
namespace dbms1 {
    ...
    public partial class dbprojectDataSet : global::System.Data.DataSet {
        ...
        public partial class studentDataTable : global::System.Data.TypedTableBase<studentRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public studentRow AddstudentRow(string usn, string name, string branch, int semester, System.DateTime dob) {
            ...
            private void InitClass() {
                ...
                this.columnusn.MaxLength = 10;
                this.columnname.AllowDBNull = false;
                this.columnname.MaxLength = 30;
                this.columnbranch.MaxLength = 5;
            }
...
namespace dbms1.dbprojectDataSetTableAdapters {
    ...
    public partial class studentTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `student` WHERE ((`usn` = @p1) AND (`name` = @p2) AND ((@p3 = 1 AND `" +
                "branch` IS NULL) OR (`branch` = @p4)) AND ((@p5 = 1 AND `semester` IS NULL) OR (" +
                "`semester` = @p6)) AND ((@p7 = 1 AND `dob` IS NULL) OR (`dob` = @p8)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `student` (`usn`, `name`, `branch`, `semester`, `dob`) VALUES (@p1, @" +
                "p2, @p3, @p4, @p5)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE `student` SET `usn` = @p1, `name` = @p2, `branch` = @p3, `semester` = @p4, `dob` = @p5 WHERE ((`usn` = @p6) AND (`name` = @p7) AND ((@p8 = 1 AND `branch` IS NULL) OR (`branch` = @p9)) AND ((@p10 = 1 AND `semester` IS NULL) OR (`semester` = @p11)) AND ((@p12 = 1 AND `dob` IS NULL) OR (`dob` = @p13)))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::dbms1.Properties.Settings.Default.dbprojectConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT `usn`, `name`, `branch`, `semester`, `dob` FROM `student`";
        ...
        public virtual int Fill(dbprojectDataSet.studentDataTable dataTable) {
        ...
        public virtual dbprojectDataSet.studentDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            dbprojectDataSet.studentDataTable dataTable = new dbprojectDataSet.studentDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(dbprojectDataSet.studentDataTable dataTable) {
        ...
        public virtual int Delete(string p1, string p2, string p4, global::System.Nullable<int> p6, global::System.Nullable<global::System.DateTime> p8) {
            if ((p1 == null)) {
        ...
        public virtual int Insert(string p1, string p2, string p3, global::System.Nullable<int> p4, global::System.Nullable<global::System.DateTime> p5) {
            if ((p1 == null)) {
                throw new global::System.ArgumentNullException("p1");
            }
            else {
        ...
        public virtual int Update(string p1, string p2, string p3, global::System.Nullable<int> p4, global::System.Nullable<global::System.DateTime> p5, string p6, string p7, string p9, global::System.Nullable<int> p11, global::System.Nullable<global::System.DateTime> p13) {
            if ((p1 == null)) {
                throw new global::System.ArgumentNullException("p1");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string p2, string p3, global::System.Nullable<int> p4, global::System.Nullable<global::System.DateTime> p5, string p6, string p7, string p9, global::System.Nullable<int> p11, global::System.Nullable<global::System.DateTime> p13) {
